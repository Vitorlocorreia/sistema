...
- Name: rbac.spec.ts >> Controle de Acesso Baseado em Funções (RBAC) >> Teste 3: Acesso Total (Admin Geral visualizando painéis restritos)
- Location: tests\rbac.spec.ts:164:7
...
Locator: getByText('Usuários & Acessos', { exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Usuários & Acessos', { exact: true })
